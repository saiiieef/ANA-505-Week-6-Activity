...
#The model did well predicting Setosa but for Versicolor and Virginica there is a difference of 2 in actual value vs predicted
#What is the accuracy rate?
# 1 - 0.26667 = 0.973 accuracy rate.
# 97.3% accuracy rate.
